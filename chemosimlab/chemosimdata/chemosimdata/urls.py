"""chemosimdata URL Configuration
...
from phandlers import views

urlpatterns = [
    url(r'^$', views.home, name='home'),
    url(r'^ligend/$', views.ligend, name='ligend'),
    #url(r'^upload/csv/$', views.upload_csv, name='upload_csv'),
    url(r'^upload/$', views.upload, name='upload'),

    url(r'^signup/$', accounts_views.signup, name='signup'),
    url(r'^login/$', auth_views.LoginView.as_view(template_name='login2.html'), name='login'),
